...
class CustomLink extends Component {
  render() {
    ...
    const styles = `transition ${classes ? classes : ''}`
...
// const twitter = () => {
//   return (
//     <svg version="1.1" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 449.956 449.956">
//       <title>Twitter</title>
//       <g>
...
// const github = () => {
//   return (
//     <svg x="0px" y="0px" width="25px" height="25px" viewBox="0 0 512 512">
//       <title>Github</title>
//       <g>
...
// const rss = () => {
//   return (
//     <svg x="0px" y="0px" width="25px" height="25px" viewBox="0 0 32 32">
//       <g>
//         <g>
//           <path fill="#22292f" d="M32,32h-4.57C27.43,16.875,15.125,4.572,0,4.572V0C17.641,0,32,14.355,32,32L32,32z"/>
//           <path fill="#22292f" d="M22.855,32h-4.57c0-10.082-8.207-18.285-18.285-18.285V9.143C12.602,9.143,22.855,19.398,22.855,32
//             L22.855,32z"/>
//           <path fill="#22292f" d="M13.715,32H9.141c0-5.043-4.098-9.141-9.141-9.141v-4.574C7.562,18.285,13.715,24.438,13.715,32
//             L13.715,32z"/>
//           <path fill="#22292f" d="M4.57,32c0-2.523-2.043-4.57-4.57-4.57V32H4.57z"/>
//         </g>
//       </g>
//     </svg>
//   )
